import { Product, Storage, Psu, Cpu, Moba, Gpu, Socket, Case, Memory, Brand, MobaChipset, MemorySpeed, MobaM2Slots, StorageType, Cooler, FormFactor, CaseFan } from '@prisma/client'; // Adjust based on your models
