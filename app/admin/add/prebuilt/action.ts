...
const schema = z.object({
  ...
  gpu_chipset_id: z.string(), 
  memory_modules: z.coerce.number().min(1).max(4), 
  cpu_cooler_type: z.string(), 
  main_storage_gb: z.coerce.number(), 
  memory_speed_id: z.string(), 
  moba_chipset_id: z.string(), 
  warranty_months: z.coerce.number(), 
  memory_module_gb: z.coerce.number(), 
  secondary_storage_gb: z.string().optional(), 
  main_storage_type_id: z.string(), 
